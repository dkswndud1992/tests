...
function updateFutureImg (selectDateStr, preDateStr) {
    ...
    var strToDate2 = new Date(y,M-1,d,h,m);
    ...
    for(i=1;i<=18;i++){
    	strToDate2.setMinutes(strToDate2.getMinutes() + 10);
        
        y = strToDate2.getFullYear();
        M = strToDate2.getMonth()+1;
        d = strToDate2.getDate();
        h = strToDate2.getHours();
        m = strToDate2.getMinutes();
